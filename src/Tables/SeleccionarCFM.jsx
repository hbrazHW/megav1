...
const SeleccionarCFM = ({ value }) => {
    ...
    return (
        <div className="dropdown m-0">
            <button className="btn p-0 h-auto" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" data-bs-target="#modalCFM" aria-expanded="false">
