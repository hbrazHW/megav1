...
import {
  loginUsuario,
  registrarUsuario,
  comprobarUsuarioDynamics,
  limpiarError,
} from "../Redux/usuarios";
import { withRouter, Link, NavLink } from "react-router-dom";
import { Toast } from "react-bootstrap";
import logo from "../img/logomegatlon.jpg";
    ...
    <animated.div className="portada" style={fade}>
      <div className="min-vh-100 vw-100 d-flex justify-content-center align-items-center login">
        ...
        <div className="p-2 col-sm-8 col-md-5 col-lg-4 col-xl-3" id="login">
          <div className="mb-2 img-thumbail">
            <img
              className="rounded mx-auto d-block logo-login"
              src={logo}
              alt="logo"
            />
          </div>
          <div className="card shadow border-0 h-auto d-flex justify-content-start borde-none pad mt-5">
              ...
              <form onSubmit={ProcesarLogin}>
                ...
                <div className="row mt-4">
                  <div className="col-sm-6">
                    <div className="form-check">
                      <input
                        className="form-check-input boton-ingresar borde-check"
                        type="checkbox"
                        value="check"
                        id="flexCheckDefault"
                        checked
                      ...
                      />
                      <label
                        className="form-check-label fs-6 fw-bold float-start"
                        hrmlfor="flexCheckDefault"
                      >
                        Recordarme
                      </label>
                    </div>
                  ...
                  <div className="col-sm-6">
                    <div className="float-right text-end">
                      <NavLink className="link-recupero " to="/recupero">
                ...
                <div className="row mt-4">
                  <div className="col-sm-12">
                    <button
                      className="btn btn-dark bg-dark btn-lg btn-block w-100 boton-ingresar borde-check"
                      type="button"
          ...
          >
            <Toast.Body className="text-white">
              <div className="row">
                ...
                <div className="col-sm-10 mt-1 ml-5">{mensaje}</div>
              </div>
            </Toast.Body>
          </Toast>
        </div>
