            ...
            <div className="card doc-cards pad borde-none">
              <div className="lista-header color-header pad ">
                <div className="row p-3">
                  <div className="col-5">Garantía</div>
                  <div className="col-7 text-end">Fecha de Vencimiento</div>
                </div>
                ...
                <ul className="list-group overflow-scroll lista-body">
                  {garantias
                    .filter((garantia) => garantia.statuscode == 100000001)
                    .map((item) => {
                      return (
                        <li
                          key={item.new_garantiaid}
                          className="list-group-item h-100 p-0 pt-2 pb-2"
                        >
                          <div className="row d-flex align-items-center px-2">
                            <div className="col-8 m-0 ">
                              <p className="text-lowercase m-0 fw-bolder texto-lista">
                                {item.new_name}
                              </p>
                            </div>
                ...
                <div className="row p-3">
                  <div className="col-12 color-header text-center c-azul fw-bolder">
                    {
                      garantias.filter(
                        (garantia) => garantia.statuscode == 100000001
                      ).length
                    }{" "}
                    Garantias
                  </div>
          ...
          <div className="card shadow p-3 border-0 d-flex justify-content-start pad">
            ...
            <div className="card doc-cards pad borde-none">
              <div className="lista-header color-header pad">
                ...
                <ul className="list-group overflow-scroll lista-body">
                  {garantias
                    .filter((garantia) => garantia.statuscode == 100000000)
                    .map((item) => {
                      return (
                        <li
                          key={item.new_garantiaid}
                ...
                <div className="row p-3">
                  <div className="col-12 color-header text-center c-azul fw-bolder">
                    {
                      garantias.filter(
                        (garantia) => garantia.statuscode == 100000000
                      ).length
                    }{" "}
                    Garantias
                  </div>
            ...
            <div className="card pad borde-none">
              <div className="lista-header color-header pad">
                ...
                <ul className="list-group w-100 overflow-auto lista-body">
                  {garantias
                    .filter((garantia) => garantia.statuscode == 100000002)
                    .map((item) => {
                      return (
                        <li
                          key={item.new_garantiaid}
                ...
                <div className="row p-3">
                  <div className="col-12 color-header text-center c-azul fw-bolder">
                    {
                      garantias.filter(
                        (garantia) => garantia.statuscode == 100000002
                      ).length
                    }{" "}
                    Garantias
                  </div>
        ...
        <div className="col-12 col-md-6 pt-5 pb-5 p-2">
          <div className="card shadow p-3 border-0 d-flex justify-content-start pad">
            ...
            <div className="card doc-cards pad borde-none">
              <div className="lista-header color-header pad">
                <div className="row p-3">
                  <div className="col-7">Garantía</div>
                  <div className="col-5 text-end">Fecha de Vencimiento</div>
                </div>
                ...
                <ul className="list-group overflow-scroll lista-body">
                  {garantias
                    .filter((garantia) => garantia.statuscode == 100000004)
                    .map((item) => {
                      return (
                        <li
                          key={item.new_productosid}
                          className="list-group-item borde-0"
                        >
                          <div className="row d-flex align-items-center pt-2 pb-2">
                            <div className="col-7 m-0 p-0 text-start">
                              <div className="row align-items-center">
                                <div className="col-2">
                                  <span className="prefijo color-header fw-bolder color-secundario rounded-circle mx-2 text-uppercase">
                                    G
                                  </span>
                                </div>
                                <div className="col-10">
                                  <p className="text-lowercase fw-bolder m-0 color-textp-lista texto-lista">
                                    {item.new_name}
                                  </p>
                                </div>
                              </div>
                            ...
                            <div className="col-5 m-0 text-end">
                              <p className="text-lowercase text-success m-0 fw-bolder texto-lista">
                                {item.new_fechadevencimiento}
                              </p>
                            </div>
                          </div>
                ...
                <div className="row p-3">
                  <div className="col-12 color-header text-center c-azul fw-bolder">
                    {
                      garantias.filter(
                        (garantia) => garantia.statuscode == 100000004
                      ).length
                    }{" "}
                    Garantias
                  </div>
          ...
          <div className="card shadow p-3 border-0 d-flex justify-content-start pad">
            ...
            <div className="card doc-cards pad borde-none">
              <div className="lista-header color-header pad">
                ...
                <ul className="list-group w-100 overflow-auto lista-body">
                  {garantias
                    .filter((garantia) => garantia.statuscode == 1)
                    .map((item) => {
                      return (
                        <li
                          key={item.new_productosid}
                          ...
                          <div className="row d-flex align-items-center pt-2 pb-2">
                            <div className="col-7 m-0 p-0 text-start">
                              <div className="row align-items-center">
                                ...
                                <div className="col-10">
                                  <p className="text-lowercase m-0 fw-bolder color-textp-lista texto-lista">
                                    {item.new_name}
                                  </p>
                                </div>
                              </div>
                ...
                <div className="row p-3">
                  <div className="col-12 color-header text-center c-azul fw-bolder">
                    {
                      garantias.filter((garantia) => garantia.statuscode == 1)
                        .length
                    }{" "}
                    Garantias
                  </div>
